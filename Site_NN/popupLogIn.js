...
(function (b) {
    b.fn.popupLogin = function (u, C) {
        function v() {
            ...
            z();
            c.data("popupLogin", a).data("id", e).css({
        ...
        function t() {
            ...
            j.unbind("keydown." + e);
            d.unbind("." + e).data("popupLogin", 0 < d.data("popupLogin") - 1 ? d.data("popupLogin") - 1 : null);
            c.undelegate(".bClose, ." + a.closeClass, "click." + e, t).data("popupLogin", null);
            D();
            return !1
        }
        ...
        function B(f) {
            f ? (d.data("popupLogin", l), c.delegate(".bClose, ." + a.closeClass, "click." + e, t), a.modalClose && b(".b-modal." + e).css("cursor", "pointer").bind("click", t), !G && (a.follow[0] || a.follow[1]) && d.bind("scroll." + e, function () {
                x && c.dequeue().animate({
        ...
        var a = b.extend({}, b.fn.popupLogin.defaults, u);
        ...
        var c = this,
            ...
            e, x, s, p, g, q, m, w, h, F;
        c.close = function () {
            a = this.data("popupLogin");
            e = "__b-popup" + d.data("popupLogin") + "__";
            t()
        };
        return c.each(function () {
            if (!b(this).data("popupLogin"))
                if (k(a.onOpen), l = (d.data("popupLogin") || 0) + 1, e = "__b-popup" + l + "__", s = "auto" !== a.position[1], p = "auto" !== a.position[0], g = "fixed" === a.positionStyle, w = c.outerHeight(!0), h = c.outerWidth(!0), a.loadUrl) switch (a.contentContainer = b(a.contentContainer || c), a.content) {
                    case "iframe":
